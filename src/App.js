  ...
  return (
    <>
      <header className="d-print-none">
        <div className="container text-center text-lg-left">
          <div className="py-3 clearfix">
            <h1 className="site-title mb-0">Mohamad Hossein Nazari</h1>
              ...
              <div className="row">
                <div className="col-md-6">
                  ...
                  >
                    ...
                    هنرستان کامپیوتر شروع کردم علاقه من به برنامه نویسی در حوضه
                    ی وب و صنعت گیمینگ باعث شد در این مسیر موفق باشم و بتونم در
                    به بهترین نحو ممکن با علاقه اموزش ببینم و کار کنم و درحال
                    تلاش برای افزایش مهارت های برنامه نویسی و اماده همکاری با یک
                    شرکت در حوضه برنامه نویسی هستم
                  </p>
                </div>
              ...
              <div className="timeline">
                ...
                <div className="timeline-card timeline-card-primary card shadow-sm">
                  <div className="card-body">
                    ...
                    <div className="Font-Persian">
                      کار ازاد رو از زمان هنرستان وقتی که وارد حوضه ی برنامه
                      نویسی شدم انجام میدادم اولین بار به حوضه ی وردپرس کار
                      میکردم و در کل به حوضه ی وب علاقه مند شدم کارهای فریلنسر
                      من میشه به انجام پروژه های <br /> UI/UX <br /> در حوضه ی
                      گیم سرور های ایرانی و وبسایت اشاره کرد
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="timeline">
                ...
                <div className="timeline-card timeline-card-success card shadow-sm">
                  <div className="card-body">
                    ...
                    <div>
                      دیپلم کامپیوتر خودم رو با معدل 18.97 از هنرستان دانش
                      رایانه دریافت کردم
                    </div>
                  </div>
                </div>
            ...
            <div className="contant-section px-3 px-lg-4 pb-4" id="contact">
              ...
              <div className="row">
                <div className="col-md-7 d-print-none">
                  <div className="my-2">
                    <form
                      action="https://formspree.io/f/mgedpayv"
                      method="POST"
                    >
                      <div className="row">
                        <div className="col-6">
      ...
      <footer className="pt-4 pb-4 text-muted text-center d-print-none">
        <div className="container">
          <div className="my-3">
            <div className="h4">Mohamad Hossein Nazari+</div>
          ...
          <div className="text-small">
            <div className="mb-1">
              &copy; Nazari Resume. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
